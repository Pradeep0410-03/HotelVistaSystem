...
## Validation
Dependency-free Node checks cover catalogue matching, aliases, combined filters, sorting, saved stays, capacity limits, calendar validity and multi-room night totals. Static validation checks asset references and JavaScript syntax. Browser layout and end-to-end testing were not performed in this pass.
